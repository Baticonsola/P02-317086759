...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(4.0f, 7.0f, 4.f));
		...
		model = glm::rotate(model, glm::radians(10.0f), glm::vec3(0.0f, 4.0f, 0.0f));
		modelaux = model;
		...
		//Llanta
		// Llanta 1
		model = glm::translate(model, glm::vec3(-2.2f, -4.5f, 1.7f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.1f, 0.0f));
		modelaux = model;
		...
		// Llanta 2
		model = glm::translate(model, glm::vec3(-0.5f, -4.7f, -0.5f));
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.1f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Llanta 3
		model = glm::translate(model, glm::vec3(3.0f, -0.5f, 0.5f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.3f, 1.0f);
		...
		// Llanta 4
		model = glm::translate(model, glm::vec3(0.5f, 5.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.3f, 1.0f);
