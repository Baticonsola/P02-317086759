...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(-1.0f, 0.0f, -6.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(4.0f, 10.0f, 4.0f));
		...
		//Cabeza
		model = glm::translate(model, glm::vec3(-6.0f, -5.5f, 1.5f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.6f, 0.3f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();

		model = modelaux;
		//Orejas
		model = glm::translate(model, glm::vec3(-9.8f, -5.0f, -1.0f));
		model = glm::rotate(model, glm::radians(10.0f), glm::vec3(8.0f, 11.0f, 0.0f));
		modelaux = model;
		...
		//articulación 1  (
		model = glm::translate(model, glm::vec3(-4.0f, 4.5f, 0.5f));
		...
		//articulación 1  (
		model = glm::translate(model, glm::vec3(2.0f, -3.2f, 1.0f));
		//rotación alrededor de la articulación que une con la cabina
		...
		//model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(20.0f, 4.0f, 4.0f));
		...
		//articulación 2  (
		model = glm::translate(model, glm::vec3(2.0f, 3.2f, -8.0f));
		//rotación alrededor de la articulación que une con la cabina
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
